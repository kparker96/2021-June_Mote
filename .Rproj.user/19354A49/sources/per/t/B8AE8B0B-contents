...
plotPCA(vstCounts, intgroup="Origin") +
  ggtitle("Original: Origin") +
  theme(legend.position = "bottom")
ggsave("PCA_Plots/origin_PCA.pdf")

plotPCA(vstCounts, intgroup="Geno") +
  ggtitle("Original: Geno") +
  theme(legend.position = "bottom")
ggsave("PCA_Plots/geno_PCA.pdf")

plotPCA(vstCounts, intgroup="Temp") +
  ggtitle("Original: Temp") +
  theme(legend.position = "bottom")
ggsave("PCA_Plots/temp_PCA.pdf")

plotPCA(vstCounts, intgroup="Timepoint")  +
  ggtitle("Original: Timepoint") +
  theme(legend.position = "bottom")
ggsave("PCA_Plots/timepoint_PCA.pdf")
