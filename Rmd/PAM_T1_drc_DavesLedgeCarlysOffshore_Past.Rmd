...
Allpam <- OPa %>%
  ...
  dplyr::select(sample_ID = SampleName, species = Species, Geno = Genotype, Location, Temp = Temp_Setpoint, Timepoint, FvFm = PAM) %>%
...
pdf("plots/2021-06-10_T3_CarlysOffshorePastRNASeq_DRC.pdf",10,7)
line_width=2
Colorz="#003A9D"
Syms=16
Denscity <- 45
...
pdf("plots/2021-06-10_T3_CarlysOffshorePastRNASeq_DRC_genofits.pdf",10,7)
...
All_ED50 %>%
  ...
  write_xlsx("ED50/Past_Offshore_Genets_ED50.xlsx")
```
...
# Individual Genotypes
pdf("plots/OPa__DRC_T3_genofits.pdf",width = 8, height = 13)
