...
#genotype predictors
AC07_pred = as.data.frame(predict(AC7drc, newdata = CBASS_preddata, interval = 'confidence'))
AC07_preddata = data.frame(CBASS_preddata, Y = AC7_pred$Prediction, Lower = AC7_pred$Lower, Upper = AC7_pred$Upper)
