...
## 2024-11-26 Cleaning up the cluster

	$ pwd
	/cm/shared/courses/dbarshis/barshislab/KatieP/taxons/Porites_astreoides/2021-12_MotePilotV1

	$ ls
	AllDESeqResults.zip  ITS2         __MACOSX  raw_data_fastqs        unzip_raw.sh             X204SC21081158-Z01-F002.zip
	BLAST                KPunzip.txt  old       reseq_raw_data_fastqs  X204SC21081158-Z01-F002

ITS2 samples are saved locally and in the archive so they can be removed from here. 

	$ rm -r ITS2

Moving raw files to the RC drive: 
	$ mv ./X204SC21081158-Z01-F002 /RC/group/rc_barshis_lab/taxonarchive/Porites_astreoides/

	$ mv ./X204SC21081158-Z01-F002.zip /RC/group/rc_barshis_lab/taxonarchive/Porites_astreoides/

Old contains incorrectly named .fq files and the raw data directory which will be moved to the RC drive. Old directory can be removed. 
