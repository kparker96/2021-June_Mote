setwd("/Users/danbarshis/dansstuff/Projeks/ODU/Projeks/Field/2021_Keys/StressExperiments/2021-06-11_MAc-Nurseryv2/scripts")
library(Hmisc)
library(lsmeans)
library(emmeans)
library(car)
...
Allpam<-read.delim("../data/PAM/2021-06-11_MoteLooeNursery_Acer.txt")
...
title(main="MoteLooeNursery_Acropora cervicornis")
...
Line_width=2.5
with(Allpam, plot(Temp,T3PAM,xlim=c(29.5,39.5),ylim=c(0,0.60), type='n', cex.axis=2.5, cex.lab=2.5, ylab="Fv/Fm", xlab="Temperature °C"))
