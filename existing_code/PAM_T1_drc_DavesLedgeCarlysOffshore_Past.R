setwd("/Users/danbarshis/dansstuff/Projeks/ODU/Projeks/Field/2021_Keys/StressExperiments/2021-06-10_OPast-RNASeq-Offshore/scripts")
library(Hmisc)
library(lsmeans)
library(emmeans)
library(car)
...
Allpam<-read.delim("../data/PAM/2021-06-10_CarlysOffshore_Past_RNASeq.txt")
...
pdf("../plots/2021-06-10_CarlysOffshorePastRNASeq_DRC.pdf",10,7)
line_width=2
Colorz="blue"
Syms=16
Denscity <- 45
...
title(main="Carly's Offshore Porites astreoides")
...
pdf("../plots/2021-06-10_CarlysOffshorePastRNASeq_DRC_genofits.pdf",10,7)
...
legend("bottomleft", col=Colours, lty=1, cex=1.75, lwd=Line_width, paste0(order(DRCpamgeno$coefficients[11:15]),": ",round(DRCpamgeno$coefficients[11:15][order(DRCpamgeno$coefficients[11:15])], digits=2)))
dev.off()
